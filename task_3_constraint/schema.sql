...
alter table users_scheme.profile add constraint profile_gender_fk foreign key (gender_id) references users_scheme.gender(ID) on delete no action on update no action;
